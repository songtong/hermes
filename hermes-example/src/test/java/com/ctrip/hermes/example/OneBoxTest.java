...
import static com.ctrip.hermes.core.utils.PlexusComponentLocator.lookup;

public class OneBoxTest {

    private static Map<String, Map<String, Integer>> m_nacks = new HashMap<String, Map<String, Integer>>();
    ...
    public static Map<String, Integer> findNacks(String groupId) {
    ...
    public static void send(String topic, String prefix) throws Exception {
        String uuid = UUID.randomUUID().toString();
