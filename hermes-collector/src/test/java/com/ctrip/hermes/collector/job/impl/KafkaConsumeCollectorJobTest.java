...
public class KafkaConsumeCollectorJobTest implements ApplicationContextAware {
	@Component
	private static class MockedKafkaConsumeCollectorJob extends KafkaConsumeCollectorJob {
		@Autowired
	...
	@Autowired
	private MockedKafkaConsumeCollectorJob m_job;
