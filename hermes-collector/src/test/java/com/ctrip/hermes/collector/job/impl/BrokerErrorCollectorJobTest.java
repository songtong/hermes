...
public class BrokerErrorCollectorJobTest implements ApplicationContextAware {
	@Component
	private static class MockedBrokerErrorCollectorJob extends BrokerErrorCollectorJob {
		@Autowired
	...
	@Autowired
	private MockedBrokerErrorCollectorJob m_job;
