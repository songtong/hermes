...
import com.ctrip.hermes.admin.core.model.AppDao;
import com.ctrip.hermes.admin.core.model.CodecDao;
...
import com.ctrip.hermes.admin.core.model.ProducerDao;
import com.ctrip.hermes.admin.core.model.ServerDao;
import com.ctrip.hermes.admin.core.model.StorageDao;
	...
	public void refactor() throws Exception {
		...
		try {
			...
			for (com.ctrip.hermes.meta.entity.Storage entity : metaEntity.getStorages().values()) {
				com.ctrip.hermes.admin.core.model.Storage storageModel = EntityToModelConverter.convert(entity);
				...
				for (com.ctrip.hermes.meta.entity.Datasource dsEntity : entity.getDatasources()) {
					com.ctrip.hermes.admin.core.model.Datasource dsModel = EntityToModelConverter.convert(dsEntity);
			...
			for (com.ctrip.hermes.meta.entity.Endpoint entity : metaEntity.getEndpoints().values()) {
				com.ctrip.hermes.admin.core.model.Endpoint endpointModel = EntityToModelConverter.convert(entity);
			...
			for (com.ctrip.hermes.meta.entity.App entity : metaEntity.getApps().values()) {
				com.ctrip.hermes.admin.core.model.App appModel = EntityToModelConverter.convert(entity);
			...
			for (com.ctrip.hermes.meta.entity.Codec entity : metaEntity.getCodecs().values()) {
				com.ctrip.hermes.admin.core.model.Codec codecModel = EntityToModelConverter.convert(entity);
			...
			for (com.ctrip.hermes.meta.entity.Topic topicEntity : metaEntity.getTopics().values()) {
				...
				for (com.ctrip.hermes.meta.entity.Partition entity : topicEntity.getPartitions()) {
					com.ctrip.hermes.admin.core.model.Partition partitionModel = EntityToModelConverter.convert(entity);
				...
				for (com.ctrip.hermes.meta.entity.Producer entity : topicEntity.getProducers()) {
					com.ctrip.hermes.admin.core.model.Producer producerModel = EntityToModelConverter.convert(entity);
				...
				for (com.ctrip.hermes.meta.entity.ConsumerGroup entity : topicEntity.getConsumerGroups()) {
					com.ctrip.hermes.admin.core.model.ConsumerGroup model = EntityToModelConverter.convert(entity);
