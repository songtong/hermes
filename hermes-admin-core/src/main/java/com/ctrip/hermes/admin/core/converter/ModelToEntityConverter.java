...
public class ModelToEntityConverter {
	...
	public static com.ctrip.hermes.meta.entity.App convert(com.ctrip.hermes.admin.core.model.App model) {
	...
	public static com.ctrip.hermes.meta.entity.Codec convert(com.ctrip.hermes.admin.core.model.Codec model) {
	...
	public static com.ctrip.hermes.meta.entity.Datasource convert(com.ctrip.hermes.admin.core.model.Datasource model) {
	...
	public static com.ctrip.hermes.meta.entity.Endpoint convert(com.ctrip.hermes.admin.core.model.Endpoint model) {
	...
	public static com.ctrip.hermes.meta.entity.Partition convert(com.ctrip.hermes.admin.core.model.Partition model) {
		com.ctrip.hermes.meta.entity.Partition entity = new com.ctrip.hermes.meta.entity.Partition();
		BeanUtils.copyProperties(model, entity, ConverterUtils.getNullPropertyNames(model));
		return entity;
	}

	public static com.ctrip.hermes.meta.entity.Producer convert(com.ctrip.hermes.admin.core.model.Producer model) {
		com.ctrip.hermes.meta.entity.Producer entity = new com.ctrip.hermes.meta.entity.Producer();
		BeanUtils.copyProperties(model, entity, ConverterUtils.getNullPropertyNames(model));
		return entity;
	}

	public static com.ctrip.hermes.meta.entity.Server convert(com.ctrip.hermes.admin.core.model.Server model) {
		com.ctrip.hermes.meta.entity.Server entity = new com.ctrip.hermes.meta.entity.Server();
		BeanUtils.copyProperties(model, entity, ConverterUtils.getNullPropertyNames(model));
		return entity;
	}

	public static com.ctrip.hermes.meta.entity.Storage convert(com.ctrip.hermes.admin.core.model.Storage model) {
		com.ctrip.hermes.meta.entity.Storage entity = new com.ctrip.hermes.meta.entity.Storage();
		BeanUtils.copyProperties(model, entity, ConverterUtils.getNullPropertyNames(model));
		return entity;
	}

	public static com.ctrip.hermes.meta.entity.Topic convert(com.ctrip.hermes.admin.core.model.Topic model) {
	...
	public static com.ctrip.hermes.meta.entity.Idc convert(com.ctrip.hermes.admin.core.model.Idc model) {
