...
<a:layout>
	...
	<div ng-app="hermes-subscription" ng-controller="subscription-controller">
		<div class="panel panel-info">
			...
			<table class="table table-hover" st-pipe="get_subscribers" st-table="subscription_table">
				<thead>
					<tr>
						<th st-sort="topic">Topic</th>
						<th st-sort="group">消费者</th>
						<th st-sort="endpoints">Endpoints</th>
						<th style="text-align: left;"><button type="button" data-toggle="modal" data-target="#add-subscriber-modal" class="btn btn-xs btn-success" style="text-align: center;">新增</button></th>
					</tr>
					<tr>
	...
	<script type="text/javascript" src="${model.webapp}/js/subcription.js"></script>
</a:layout>