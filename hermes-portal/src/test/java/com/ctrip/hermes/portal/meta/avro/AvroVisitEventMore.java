...
public class AvroVisitEventMore extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static com.ctrip.hermes.portal.meta.avro.AvroVisitEventMore.Builder newBuilder() {
    return new com.ctrip.hermes.portal.meta.avro.AvroVisitEventMore.Builder();
  }
  
  /** Creates a new AvroVisitEventMore RecordBuilder by copying an existing Builder */
  public static com.ctrip.hermes.portal.meta.avro.AvroVisitEventMore.Builder newBuilder(com.ctrip.hermes.portal.meta.avro.AvroVisitEventMore.Builder other) {
    return new com.ctrip.hermes.portal.meta.avro.AvroVisitEventMore.Builder(other);
  }
  
  /** Creates a new AvroVisitEventMore RecordBuilder by copying an existing AvroVisitEventMore instance */
  public static com.ctrip.hermes.portal.meta.avro.AvroVisitEventMore.Builder newBuilder(com.ctrip.hermes.portal.meta.avro.AvroVisitEventMore other) {
    return new com.ctrip.hermes.portal.meta.avro.AvroVisitEventMore.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<AvroVisitEventMore>
    ...
    private Builder() {
      super(com.ctrip.hermes.portal.meta.avro.AvroVisitEventMore.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.ctrip.hermes.portal.meta.avro.AvroVisitEventMore.Builder other) {
      super(other);
    ...
    private Builder(com.ctrip.hermes.portal.meta.avro.AvroVisitEventMore other) {
            super(com.ctrip.hermes.portal.meta.avro.AvroVisitEventMore.SCHEMA$);
      if (isValidValue(fields()[0], other.ip)) {
        this.ip = data().deepCopy(fields()[0].schema(), other.ip);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'ip' field */
    public com.ctrip.hermes.portal.meta.avro.AvroVisitEventMore.Builder setIp(java.lang.CharSequence value) {
    ...
    public com.ctrip.hermes.portal.meta.avro.AvroVisitEventMore.Builder clearIp() {
      ip = null;
    ...
    /** Sets the value of the 'url' field */
    public com.ctrip.hermes.portal.meta.avro.AvroVisitEventMore.Builder setUrl(java.lang.CharSequence value) {
    ...
    public com.ctrip.hermes.portal.meta.avro.AvroVisitEventMore.Builder clearUrl() {
      url = null;
    ...
    /** Sets the value of the 'tz' field */
    public com.ctrip.hermes.portal.meta.avro.AvroVisitEventMore.Builder setTz(long value) {
    ...
    public com.ctrip.hermes.portal.meta.avro.AvroVisitEventMore.Builder clearTz() {
    ...
    /** Sets the value of the 'who' field */
    public com.ctrip.hermes.portal.meta.avro.AvroVisitEventMore.Builder setWho(java.lang.CharSequence value) {
    ...
    public com.ctrip.hermes.portal.meta.avro.AvroVisitEventMore.Builder clearWho() {
      who = null;
