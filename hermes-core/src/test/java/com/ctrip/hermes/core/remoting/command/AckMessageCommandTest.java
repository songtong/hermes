...
public class AckMessageCommandTest {
	...
	// // ack start
	// // t1
	// cmd.addAckMsg(new Tpp("t1", 1, true), "g1", false, 1, 0, now);
	// cmd.addAckMsg(new Tpp("t1", 1, true), "g1", false, 2, 0, now);
	//
	// cmd.addAckMsg(new Tpp("t1", 1, false), "g1", false, 1, 0, now);
	// cmd.addAckMsg(new Tpp("t1", 1, false), "g1", false, 2, 0, now);
	// cmd.addAckMsg(new Tpp("t1", 1, false), "g1", false, 3, 0, now);
	//
	// cmd.addAckMsg(new Tpp("t1", 2, true), "g1", false, 1, 0, now);
	// cmd.addAckMsg(new Tpp("t1", 2, true), "g1", false, 2, 0, now);
	// cmd.addAckMsg(new Tpp("t1", 2, true), "g1", false, 3, 0, now);
	// cmd.addAckMsg(new Tpp("t1", 2, true), "g1", false, 4, 0, now);
	//
	// // t2
	// cmd.addAckMsg(new Tpp("t2", 1, true), "g2", true, 1, 1, now);
	// cmd.addAckMsg(new Tpp("t2", 1, true), "g2", true, 2, 2, now);
	//
	// cmd.addAckMsg(new Tpp("t2", 1, false), "g2", true, 1, 1, now);
	// cmd.addAckMsg(new Tpp("t2", 1, false), "g2", true, 2, 2, now);
	// cmd.addAckMsg(new Tpp("t2", 1, false), "g2", true, 3, 3, now);
	//
	// cmd.addAckMsg(new Tpp("t2", 2, false), "g2", true, 1, 4, now);
	// cmd.addAckMsg(new Tpp("t2", 2, false), "g2", true, 2, 3, now);
	// cmd.addAckMsg(new Tpp("t2", 2, false), "g2", true, 3, 2, now);
	// cmd.addAckMsg(new Tpp("t2", 2, false), "g2", true, 4, 1, now);
	// // ack end
	//
	// // nack start
	// // t1
	// cmd.addNackMsg(new Tpp("t1", 1, true), "g1", false, 1, 0, now);
	// cmd.addNackMsg(new Tpp("t1", 1, true), "g1", false, 2, 0, now);
	//
	// cmd.addNackMsg(new Tpp("t1", 1, false), "g1", false, 1, 0, now);
	// cmd.addNackMsg(new Tpp("t1", 1, false), "g1", false, 2, 0, now);
	// cmd.addNackMsg(new Tpp("t1", 1, false), "g1", false, 3, 0, now);
	//
	// cmd.addNackMsg(new Tpp("t1", 2, true), "g1", false, 1, 0, now);
	// cmd.addNackMsg(new Tpp("t1", 2, true), "g1", false, 2, 0, now);
	// cmd.addNackMsg(new Tpp("t1", 2, true), "g1", false, 3, 0, now);
	// cmd.addNackMsg(new Tpp("t1", 2, true), "g1", false, 4, 0, now);
	//
	// // t2
	// cmd.addNackMsg(new Tpp("t2", 1, true), "g2", true, 1, 1, now);
	// cmd.addNackMsg(new Tpp("t2", 1, true), "g2", true, 2, 2, now);
	//
	// cmd.addNackMsg(new Tpp("t2", 1, false), "g2", true, 1, 1, now);
	// cmd.addNackMsg(new Tpp("t2", 1, false), "g2", true, 2, 2, now);
	// cmd.addNackMsg(new Tpp("t2", 1, false), "g2", true, 3, 3, now);
	//
	// cmd.addNackMsg(new Tpp("t2", 2, false), "g2", true, 1, 4, now);
	// cmd.addNackMsg(new Tpp("t2", 2, false), "g2", true, 2, 3, now);
	// cmd.addNackMsg(new Tpp("t2", 2, false), "g2", true, 3, 2, now);
	// cmd.addNackMsg(new Tpp("t2", 2, false), "g2", true, 4, 1, now);
	// // nack end
	//
