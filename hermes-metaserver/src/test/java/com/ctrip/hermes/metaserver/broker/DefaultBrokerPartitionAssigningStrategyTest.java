...
public class DefaultBrokerPartitionAssigningStrategyTest {
	...
	public void testBrokerAdded() throws Exception {
		...
		Map<String, ClientContext> brokers = createBrokers(Arrays.asList(//
		      new ClientContext("br0", "0.0.0.0", 1234, now),//
		      new ClientContext("br1", "0.0.0.1", 1234, now)//
		      ));
		...
		Map<String, Assignment<Integer>> originAssignments = createAssignments(Arrays.asList(//
		      new Pair<>(new Pair<>("t1", 0), new ClientContext("br0", "0.0.0.0", 1234, now)),//
		      new Pair<>(new Pair<>("t1", 1), new ClientContext("br0", "0.0.0.0", 1234, now)),//
		      new Pair<>(new Pair<>("t3", 0), new ClientContext("br0", "0.0.0.0", 1234, now)),//
		      new Pair<>(new Pair<>("t3", 1), new ClientContext("br0", "0.0.0.0", 1234, now))//
	...
	public void testBrokerDeleted() throws Exception {
		...
		Map<String, Assignment<Integer>> originAssignments = createAssignments(Arrays.asList(//
		      new Pair<>(new Pair<>("t1", 0), new ClientContext("br0", "0.0.0.0", 1234, now)),//
		      new Pair<>(new Pair<>("t1", 1), new ClientContext("br1", "0.0.0.1", 1234, now)),//
		      new Pair<>(new Pair<>("t3", 0), new ClientContext("br0", "0.0.0.0", 1234, now)),//
		      new Pair<>(new Pair<>("t3", 1), new ClientContext("br1", "0.0.0.1", 1234, now))//
	...
	public void testTopicAndBrokerAllChanged() throws Exception {
		...
		Map<String, ClientContext> brokers = createBrokers(Arrays.asList(//
		      new ClientContext("br0", "0.0.0.0", 1234, now),//
		      new ClientContext("br2", "0.0.0.2", 1234, now)//
		      ));
