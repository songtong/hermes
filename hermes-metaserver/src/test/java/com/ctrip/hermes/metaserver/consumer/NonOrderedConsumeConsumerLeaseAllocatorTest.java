...
public class NonOrderedConsumeConsumerLeaseAllocatorTest {
	...
	private NonOrderedConsumeConsumerLeaseAllocator m_allocator;
	...
	public void before() throws Exception {
		m_allocator = new NonOrderedConsumeConsumerLeaseAllocator();
	...
	public void testAcquireLeaseSuccessAndNoExistingLease() throws Exception {
		...
		ClientContext consumer = new ClientContext(consumerName, "1.1.1.1", 1234, 1L);
	...
	@Test
	public void testAcquireLeaseSuccessAndAnotherConsumerHoldingLease() throws Exception {
		String topic = "topic";
		String group = "g1";
		int partition = 1;
		String consumerName = "c1";
		...
		Assignment<Integer> assignment = new Assignment<Integer>();
		Map<String, ClientContext> consumers = new HashMap<>();
		ClientContext consumer = new ClientContext(consumerName, ip, port, 1L);
		consumers.put(consumerName, consumer);
		assignment.addAssignment(partition, consumers);
